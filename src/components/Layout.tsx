...
const navItems = [
  ...
  { icon: BarChart3, label: 'AI Intelligence', path: '/intelligence' },
  { icon: Lightbulb, label: 'AI Recommendations', path: '/recommendations' },
  { icon: Trophy, label: 'Green Credits', path: '/credits' },
  { icon: AlertTriangle, label: 'Report Dumping', path: '/report' },
  { icon: ShieldCheck, label: 'Admin Governance', path: '/admin' },
];
    ...
    <div className="min-h-screen bg-[#050a05] text-white font-sans selection:bg-emerald-500/30">
      ...
      <main className={cn(
        ...
        <header className="h-20 border-b border-emerald-900/20 bg-black/20 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-40">
          <div>
            <h2 className="text-sm font-medium text-emerald-500/80 uppercase tracking-widest">Waste Intelligence Platform</h2>
            <h1 className="text-xl font-bold">Smart City Command Center</h1>
          </div>
          
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2 bg-emerald-500/10 px-4 py-2 rounded-full border border-emerald-500/20">
              <div className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse" />
              <span className="text-xs font-semibold text-emerald-400">LIVE: NEW DELHI</span>
            </div>
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-emerald-900/30">
              <div className="text-right hidden sm:block">
                ...
                <p className="text-xs text-emerald-500/70">Governance Officer</p>
              </div>
